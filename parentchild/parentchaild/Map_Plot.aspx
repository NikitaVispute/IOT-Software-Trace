<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Map_Plot.aspx.cs" Inherits="Map_Plot" %>
    ...
    <div id="main">
        ...
        <div id="site_content">
            ...
            <div id="content">
                ...
                <h1>
                    Soldier Current Location &nbsp&nbsp<asp:Label ID="lblmessage" runat="server" Text=""></asp:Label>
                </h1>
                <table>
                    <tr>
                        <td>
                        ...
                        <td>
                            <asp:TextBox ID="txtlat" runat="server" Enabled="False"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="txtlon" runat="server" Enabled="False"></asp:TextBox>
